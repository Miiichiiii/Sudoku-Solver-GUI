...
if __name__ == '__main__':
    matrix = [[5, None, None, 9, None, None, 2, None, None],
              [None, None, None, None, None, 7, None, None, None],
              [8, None, None, 6, None, None, None, 4, None],
              [None, 6, None, None, 7, None, None, 1, 4],
              [None, None, None, None, None, None, None, 6, 7],
              [3, 7, 4, 5, 6, 1, 8, 2, 9],
              [4, 9, None, 8, None, None, None, None, None],
              [None, 1, None, 7, 4, 5, None, None, None],
              [7, None, 3, None, None, None, 4, None, None]]
